        ...
        <div class="c4">
            <div class="card">
                ...
                <div class="card_cuerpo">
                    <p>
                    <ul>
                        <li>El 26 de septiembre a las 4:00 pm se realizaran clases de bailes típicos</li>
                        <li>El 30 de septiembre se llevara a cabo una feria cultural y se darán muestras de comidas
                            típicas</li>
                        <li>El 02 de octubre se efectura una salida turística hacia Juanchaco</li>
                    </ul>
                    </p>
                </div>
            </div>
